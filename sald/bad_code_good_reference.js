...
function main() {
    ...
    //Setup setup matrix
    var angleX2 = 0;
    var angleY2 = Math.PI / 2;

    var setupMatrix = [cos(angleX2), sin(angleX2),
    cos(angleY2), sin(angleY2)];
    setupMatrix[0] *= scale;
    setupMatrix[1] *= scale;
    setupMatrix[2] *= scale;
    setupMatrix[3] *= scale;
    setupMatrix[4] = displayCenter[0];
    setupMatrix[5] = displayCenter[1];
    ...
    function setWorldTransform() {
        c.setTransform.apply(c, setupMatrix);
    }
    //    equivalent to :
    ...
    function drawFilledTile(colOffset, rowOffset, tileValue) {
        ...
        // var pt = [colOffset, rowOffset];
        // project(transfMatrix, pt);
